...
また、レシピで使用する食材（調味料含む）にアレルギー表示対象の28品目
（えび、かに、くるみ、小麦、そば、卵、乳、落花生（ピーナッツ）、アーモンド、あわび、いか、いくら、オレンジ、カシューナッツ、
キウイフルーツ、牛肉、ごま、さけ、さば、大豆、鶏肉、バナナ、豚肉、まつたけ、もも、やまいも、りんご、ゼラチン）が含まれる場合、
該当する品目を "allergens" にリスト形式で出力してください。含まれない場合は空配列 "[]" としてください。：
[
  {{
    "recipeName": "料理名",
