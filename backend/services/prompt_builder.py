...
レシピで使用する食材（調味料含む）にアレルギー表示対象の28品目
（えび、かに、くるみ、小麦、そば、卵、乳、落花生（ピーナッツ）、アーモンド、あわび、いか、いくら、オレンジ、カシューナッツ、
キウイフルーツ、牛肉、ごま、さけ、さば、大豆、鶏肉、バナナ、豚肉、まつたけ、もも、やまいも、りんご、ゼラチン）
が含まれる場合、該当する品目を "allergens" にリスト形式で出力してください。含まれない場合は空配列 "[]" としてください。
"ingredients"に入れる材料は、主材料・副材料・調味料・トッピング類の順で書いて下さい、使用しない場合は飛ばして次の材料を書いてください
"step"に書かれた作り方の手順と、材料の順番が連動しているとなお良いです、材料は本・g・mlなどの分量も表示してください。
"steps"に入れる手順は、下準備・調理・仕上げ(必ず3つに分けて書かないといけないわけではなく、
例えば「調理」という大まかな区切りの中に細かく数個手順があっても構わない)の流れで作業の流れを妨げないタイミングで区切り、
なるべく短く簡潔(1行～3行)に書いてください：
[
  {{
    "recipeName": "料理名",
    "servings":"〇人分",
